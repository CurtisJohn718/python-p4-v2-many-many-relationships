...
# Association table to store many-to-many relationships between employees and meetings
...
# Association Model to store many-to-many relationships between employee and project
